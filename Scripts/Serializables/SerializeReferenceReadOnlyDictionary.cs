...
namespace UniT.Extensions
{
    ...
    [Serializable]
    public class SerializeReferenceReadOnlyDictionary<TKey, TValue> : IReadOnlyDictionary<TKey, TValue> where TKey : notnull
    {
        [SerializeField] private SerializeReferenceDictionary<TKey, TValue> values;

        public SerializeReferenceReadOnlyDictionary() : this(new())
        {
        }

        public SerializeReferenceReadOnlyDictionary(SerializeReferenceDictionary<TKey, TValue> values)
        {
            this.values = values;
        }
