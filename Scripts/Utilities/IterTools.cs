...
namespace UniT.Extensions
{
    ...
    {
        [Pure]
        public static IEnumerable<TResult> Zip<TFirst, TSecond, TResult, TState>(IEnumerable<TFirst> first, IEnumerable<TSecond> second, Func<TFirst, TSecond, TState, TResult> resultSelector, TState state)
        {
        ...
        [Pure]
        public static IEnumerable<TResult> Zip<TFirst, TSecond, TThird, TResult, TState>(IEnumerable<TFirst> first, IEnumerable<TSecond> second, IEnumerable<TThird> third, Func<TFirst, TSecond, TThird, TState, TResult> resultSelector, TState state)
        {
            using var enumerator1 = first.GetEnumerator();
            using var enumerator2 = second.GetEnumerator();
        ...
        {
            return Zip(first, second, static (item1, item2, resultSelector) => resultSelector(item1, item2), resultSelector);
        }
        ...
        {
            return Zip(first, second, third, static (item1, item2, item3, resultSelector) => resultSelector(item1, item2, item3), resultSelector);
        }
        ...
        {
            return Zip(first, second, static (item1, item2) => (item1, item2));
        }
        ...
        {
            return Zip(first, second, third, static (item1, item2, item3) => (item1, item2, item3));
        }

        [Pure]
        public static IEnumerable<TResult> ZipShortest<TFirst, TSecond, TResult, TState>(IEnumerable<TFirst> first, IEnumerable<TSecond> second, Func<TFirst, TSecond, TState, TResult> resultSelector, TState state)
        {
            using var enumerator1 = first.GetEnumerator();
            using var enumerator2 = second.GetEnumerator();
        ...
        [Pure]
        public static IEnumerable<TResult> ZipShortest<TFirst, TSecond, TThird, TResult, TState>(IEnumerable<TFirst> first, IEnumerable<TSecond> second, IEnumerable<TThird> third, Func<TFirst, TSecond, TThird, TState, TResult> resultSelector, TState state)
        {
            using var enumerator1 = first.GetEnumerator();
            using var enumerator2 = second.GetEnumerator();
            using var enumerator3 = third.GetEnumerator();
        ...
        {
            return ZipShortest(first, second, static (item1, item2, resultSelector) => resultSelector(item1, item2), resultSelector);
        }
        ...
        {
            return ZipShortest(first, second, third, static (item1, item2, item3, resultSelector) => resultSelector(item1, item2, item3), resultSelector);
        }
        ...
        {
            return ZipShortest(first, second, static (item1, item2) => (item1, item2));
        }
        ...
        {
            return ZipShortest(first, second, third, static (item1, item2, item3) => (item1, item2, item3));
        }

        [Pure]
        public static IEnumerable<TResult> ZipLongest<TFirst, TSecond, TResult, TState>(IEnumerable<TFirst> first, IEnumerable<TSecond> second, Func<TFirst?, TSecond?, TState, TResult> resultSelector, TState state)
        {
            using var enumerator1 = first.GetEnumerator();
            using var enumerator2 = second.GetEnumerator();
        ...
        [Pure]
        public static IEnumerable<TResult> ZipLongest<TFirst, TSecond, TThird, TResult, TState>(IEnumerable<TFirst> first, IEnumerable<TSecond> second, IEnumerable<TThird> third, Func<TFirst?, TSecond?, TThird?, TState, TResult> resultSelector, TState state)
        {
            using var enumerator1 = first.GetEnumerator();
            using var enumerator2 = second.GetEnumerator();
            using var enumerator3 = third.GetEnumerator();
        ...
        {
            return ZipLongest(first, second, static (item1, item2, resultSelector) => resultSelector(item1, item2), resultSelector);
        }
        ...
        {
            return ZipLongest(first, second, third, static (item1, item2, item3, resultSelector) => resultSelector(item1, item2, item3), resultSelector);
        }
        ...
        {
            return ZipLongest(first, second, static (item1, item2) => (item1, item2));
        }
        ...
        {
            return ZipLongest(first, second, third, static (item1, item2, item3) => (item1, item2, item3));
        }

        [Pure]
        public static IEnumerable<TResult> Product<TFirst, TSecond, TResult, TState>(IEnumerable<TFirst> first, IEnumerable<TSecond> second, Func<TFirst, TSecond, TState, TResult> resultSelector, TState state)
        {
        ...
        [Pure]
        public static IEnumerable<TResult> Product<TFirst, TSecond, TThird, TResult, TState>(IEnumerable<TFirst> first, IEnumerable<TSecond> second, IEnumerable<TThird> third, Func<TFirst, TSecond, TThird, TState, TResult> resultSelector, TState state)
        {
            var firstCollection = first as ICollection<TFirst> ?? first.ToArray();
            var secondCollection = second as ICollection<TSecond> ?? second.ToArray();
            ...
            foreach (var item1 in firstCollection)
            {
                foreach (var item2 in secondCollection)
                {
                    foreach (var item3 in thirdCollection)
                    {
                        yield return resultSelector(item1, item2, item3, state);
                    }
                }
        ...
        {
            return Product(first, second, static (item1, item2, resultSelector) => resultSelector(item1, item2), resultSelector);
        }
        ...
        {
            return Product(first, second, third, static (item1, item2, item3, resultSelector) => resultSelector(item1, item2, item3), resultSelector);
        }
        ...
        {
            return Product(first, second, static (item1, item2) => (item1, item2));
        }
        ...
        {
            return Product(first, second, third, static (item1, item2, item3) => (item1, item2, item3));
        }
